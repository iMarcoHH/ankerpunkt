    ...
    <div className="min-h-screen bg-[#0D1B2A] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl p-8 shadow-2xl">
          <div className="text-xs font-mono-ak text-[#C8392B] tracking-[0.2em] uppercase mb-2">// Willkommen zurück</div>
          <h1 className="font-bebas text-3xl tracking-wider text-[#0D1B2A] mb-6">ANMELDEN</h1>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input type="password" value={password} onChange={e => setPassword(e.target.value)} className="ak-input" placeholder="••••••••" required />
            </div>
          ...
          <div className="mt-6 text-center text-sm text-[#9AA0A6]">
            Noch kein Konto?{' '}<a href="/register" className="text-[#C8392B] font-medium hover:underline">Registrieren</a>
          </div>
        </div>
      </div>
    </div>
